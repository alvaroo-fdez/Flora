...
public class AddImagenActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        etIdFlora2 = findViewById(R.id.etIDFlora2);
    ...
    private void uploadDataImage() {
        ...
        TextInputLayout tpID = findViewById(R.id.textInputLayoutID);
        TextInputLayout tpDescription = findViewById(R.id.textInputLayoutDescription);
        ...
        if(!(nombre.trim().isEmpty() ||
            ...
            if(idFlora.trim().isEmpty()){
                tpID.setError("Introduzca un ID");
            }
            if(descripcion.trim().isEmpty()){
                tpDescription.setError("Introduzca una descripción");
            }
        }
    }
